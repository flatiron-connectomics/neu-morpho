"""em-seg-morpho: segment morphology from segmentation volumes.
...
format, orchestrated across segments with ``em-blockrun`` and reading segmentation
arrays with ``em-volume-tools``.
